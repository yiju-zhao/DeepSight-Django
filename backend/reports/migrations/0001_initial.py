    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_ids', models.JSONField(blank=True, default=list, help_text='List of source IDs from knowledge base')),
                ('csv_session_code', models.CharField(blank=True, max_length=100)),
                ('csv_date_filter', models.CharField(blank=True, max_length=20)),
                ('model_provider', models.CharField(choices=[('openai', 'OpenAI'), ('google', 'Google'), ('xinference', 'Xinference')], default='openai', max_length=50)),
                ('model_uid', models.CharField(blank=True, max_length=200, null=True)),
