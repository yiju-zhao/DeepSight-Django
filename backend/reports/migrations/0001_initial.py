    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_id', models.CharField(blank=True, help_text='Background job ID for tracking', max_length=100, unique=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('notebooks', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reports', to='notebooks.notebook')),
