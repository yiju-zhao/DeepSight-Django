...
class AsyncService(BaseService):
    ...
    def start_async_task(self, task_function, *args, **kwargs):
        ...
        self.log_operation(
            "async_task_started", task_id=task.id, task_name=self.task_name
        )
...
class NotebookBaseService(BaseService):
    ...
    def log_notebook_operation(
        self, operation: str, notebook_id: str, user_id: int, **kwargs
    ):
        """
        ...
        """
        self.log_operation(
            operation, notebook_id=notebook_id, user_id=user_id, **kwargs
        )
