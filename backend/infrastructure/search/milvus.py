...
class MilvusSearch(SearchInterface):
    ...
    def insert_vectors(
        ...
        try:
            ...
            data = [ids, vectors, metadata_strings]
    ...
    def search_vectors(
        ...
        try:
            ...
            self.logger.debug(
                f"Found {len(search_results)} similar vectors in {collection_name}"
            )
    ...
    def collection_exists(self, collection_name: str) -> bool:
        ...
        try:
            ...
            self.logger.error(
                f"Failed to check collection existence {collection_name}: {e}"
            )
            return False
