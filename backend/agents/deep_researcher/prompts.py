"""
Prompts for Deep Researcher Agent

This module contains all prompts used by the research agent workflow.
These prompts are extracted from the original Deep_Research/src/prompts.py
and focus only on research-related functionality.

Report generation prompts are in report_writer/prompts.py.
"""
...
<Task>
Your focus is to call the "ConductResearch" tool to conduct research against the overall research question passed in by the user. When you are completely satisfied with the research findings, then you should call the "ResearchComplete" tool to indicate that you are done with your research.
</Task>
...
4. **Call ResearchComplete when satisfied** - When you have gathered comprehensive findings
</Instructions>
