...
class ClarificationResult(BaseModel):
    ...
    confident: bool = Field(
        default=False,
        description="Whether the coordinator is confident to proceed"
    )
    extracted_requirements: Dict[str, Any] = Field(
        default_factory=dict,
        description="Requirements extracted from conversation"
    )
    verification_message: str = Field(
        default="",
        description="Message confirming understanding if confident"
    )
...
class TaskOptions(BaseModel):
    ...
    task_type: Optional[TaskType] = Field(
        default=None,
        description="Type of task to execute. If None, auto-detected."
    )
    style: str = Field(
        default="academic",
        description="Writing style for reports"
    )
    max_research_iterations: Optional[int] = Field(
        default=None,
    ...
    skip_clarification: bool = Field(
        default=False,
        description="Skip clarification phase"
    )
...
class TaskResult(BaseModel):
    ...
    plan: Optional[TaskPlan] = Field(default=None, description="Execution plan")
