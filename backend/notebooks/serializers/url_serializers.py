...
class URLParseWithMediaSerializer(serializers.Serializer):
    ...
    url = serializers.URLField(help_text="URL to parse and extract media from")
    upload_url_id = serializers.CharField(
        max_length=64, required=False, help_text="Custom upload ID for tracking"
    )
...
class URLParseDocumentSerializer(serializers.Serializer):
    ...
    url = serializers.URLField(help_text="URL to download and validate document from")
    upload_url_id = serializers.CharField(
        max_length=64, required=False, help_text="Custom upload ID for tracking"
    )
