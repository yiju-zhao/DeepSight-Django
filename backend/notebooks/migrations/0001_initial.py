    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('parsing_status', models.CharField(choices=[('queueing', 'Queueing'), ('parsing', 'Parsing'), ('captioning', 'Captioning'), ('done', 'Done'), ('failed', 'Failed')], db_index=True, default='queueing', help_text='Parsing status of this knowledge base item', max_length=20)),
