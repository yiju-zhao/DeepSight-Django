...
const RAGStatus: React.FC = () => {
    ...
    // This prevents the status from appearing in the chat panel
    ...
    // Calculate progress
    // If we have 'completed' status or generation is complete, show full completion
    ...
    if (currentIndex === -1) {
        ...
        const stepMapping: Record<string, number> = {
            ...
            'planning': 1,
            'retrieving': 2,
            'grade_relevance': 2,  // Part of retrieving phase
            'grading_relevance': 2,  // Part of retrieving phase
            'reordering': 3,
            'synthesizing': 4,
            'prepare_generation': 4,  // Part of synthesis phase
            'completed': 5,  // Beyond all steps
        };
        currentIndex = stepMapping[currentStepId] ?? 0;
    }

    // If completed or have generation with completed status, mark as done
