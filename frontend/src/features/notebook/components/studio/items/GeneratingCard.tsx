...
const GeneratingCard: React.FC<GeneratingCardProps> = ({ item, onDelete }) => {
  ...
  return (
    <div className={`relative overflow-hidden cursor-default group transition-colors duration-150 ${bgColor} rounded-lg px-4 border border-transparent`}>
      <div className="flex items-center justify-between py-3 h-16">
        <div className="flex items-center space-x-4 flex-1 min-w-0">
          {/* Loading icon */}
          <div className="w-8 h-8 flex items-center justify-center flex-shrink-0 bg-white/50 rounded-full">
