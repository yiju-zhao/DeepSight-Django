        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            {showBackButton && (
              <button
                ...
                className="p-2 rounded-lg bg-white hover:bg-secondary shadow-sm hover:shadow-md transition-all duration-300"
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-secondary transition-all duration-300"
              ...
              <h1 className="text-[16px] md:text-[18px] font-semibold text-gray-900 leading-tight">
          ...
          {onOpenSettings && (
            <button
              ...
              className="p-2 rounded-lg bg-white hover:bg-secondary shadow-sm hover:shadow-md transition-all duration-300 text-muted-foreground hover:text-gray-900"
