 ...
 * File Configuration
 * 
 * Centralizes file type mappings, status configurations, MIME types,
 * and validation rules for file management in the notebook feature.
 */
...
export const VALIDATION_CONFIG = {
    allowedExtensions: [
        "pdf", "txt", "md", "pptx", "ppt", "docx", "doc", "xlsx", "xls",
    ...
    acceptString: ".pdf,.txt,.md,.pptx,.ppt,.docx,.doc,.xlsx,.xls,.mp3,.mp4,.wav,.m4a,.avi,.mov,.mkv,.webm,.flv,.wmv,.3gp,.ogv,.m4v"
};
